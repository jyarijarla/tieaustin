export const defaults = {
  stats: [
    ...
    { value: '61',      label: 'Chapters' },
  ],

  hero: {
    imageSrc: '/Hero%20(3).png',
  },

  joinCTA: {
    heading: 'Ready to Join?',
    body: 'TiE Austin membership opens doors to mentors, events, and a community of people building real companies in Texas.',
  },

  contact: {
    email: 'ExecutiveDirector@austin.tie.org',
    description: 'For membership inquiries, partnerships, sponsorships, or general questions, reach us directly.',
  },
